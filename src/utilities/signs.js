...
const aries = {name: 'Aries', }
const taurus = {name: 'Taurus', }
const gemini = {name: 'Gemini', }
const cancer = {name: 'Cancer', }
const leo = {name: 'Leo', }
const virgo = {name: 'Virgo', }
const libra = {name: 'Libra', }
const scorpio = {name: 'Scorpio', }
const sagittarius = {name: 'Sagittarius', }
const capricorn = {name: 'Capricorn', }
const aquarius = {name: 'Aquarius', }
